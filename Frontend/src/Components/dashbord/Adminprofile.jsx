...
export default function Adminprofile() {
  return (
    <div className="aside  h-[90vh] p-10  overflow-hidden   border-r-2 shadow-r-xl text-zinc-700 font-extralight">
      <div className="options  rounded-lg ">
        <ul className="font-lighter">
          <li className="text-zinc-400 leading-10 tracking-wider text-sm">
            DASHBOARD
          </li>
          <li className="flex items-center gap-1 px-4 py-1 my-1 rounded-lg text-[14px] font-extrabold hover:bg-blue-100 hover:text-blue-400  ">
