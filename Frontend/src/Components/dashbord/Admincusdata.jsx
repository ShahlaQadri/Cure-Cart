...
export const ADMIN_CUS_DATA = [
  ...
  {
    photo: "../../../pictures/user.png",
    name: "Chance Curtis",
    gender: "Male",
    email: "bester@yahoo.ca",
    role: "User",
    action: <AiFillDelete />,
  },
  {
...
export const ADMIN_CUS_COLUMNS = [
    ...
    { Header: 'Action', accessor: 'action', Cell: ({ value }) => <div className="flex justify-center items-center text-2xl"><AiFillDelete className="text-red-600 text-md -ml-10"/></div>},
