...
export default function Productcard({ img, name, desc }) {
  return (
    <div className="h-[230px] flex-shrink-0 w-[160px] md:w-[250px] bg-[#F1F5F9] md:h-[340px] overflow-hidden rounded-3xl flex flex-col items-center justify-center shadow-sm hover:shadow-md">
      ...
      <div className="h-[36%] w-full md:h-[37%] md:flex md:flex-col  md:w-full  rounded-3xl md:overflow-hidden bg-white md:-mt-4 md:items-center md:justify-center">
        ...
        <div className="flex text-center px-2 mt-2 md:px-5 md:mt-5 md:mb-5 justify-between items-center w-full ">
          <span className="line-through text-[8px] text-red-700">$600</span>
          <span className="text-[10px] text-black leading-tighter mr-16 md:mr-16">
            $560
          </span>
