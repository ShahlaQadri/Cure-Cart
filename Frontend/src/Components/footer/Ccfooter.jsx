...
export default function Ccfooter() {
  return (
    <div className="outer bg-[#EAF7FF] flex flex-col  items-center justify-center mx-0 h-[200px] md:h-[270px] rounded-3xl">
      <div className="inner bg-white h-[165px] w-[95%] md:h-[225px] md:w-[90%] rounded-3xl pb-10">
        <div className="items flex items-center justify-evenly space-x-16 mt-4 mb-6 md:mt-5  md:mb-8">
          ...
          <ul className="space-y-1 md:space-y-2">
            <li className="md:pb-3 text-sm md:text-lg font-bold">Community</li>
            <li className="text-[10px] md:text-sm leading-1">CureCart for Business</li>
            <li className="text-[10px] md:text-sm leading-none">About Us</li>
            <li className="text-[10px] md:text-sm leading-none">Contact Us</li>
          </ul>
          ...
          <ul className="space-y-1 md:space-y-2">
            ...
            <li className="text-[10px] md:text-sm leading-1">
              Getting Started
            </li>
            <li className="text-[10px] md:text-sm leading-1">FAQs</li>
            <li className="text-[10px] md:text-sm leading-1">
              Report a Violation
            </li>
          </ul>
        ...
        <div className="w-full flex items-center justify-between px-[1rem] md:px-[8rem] text-zinc-500  ">
          <span className=" text-xl md:text-2xl font-bold md:font-extrabold ">
            <img src="../../../pictures/smalllogo.png" width={"80px md:130px"} alt="" />
          </span>
