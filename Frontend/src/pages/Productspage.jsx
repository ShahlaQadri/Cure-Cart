...
const addToCartHandler = (cartItem) => {
    ...
    <div className="rounded-lg w-[100%]  mx-auto">
      <div className="category ralative flex bg-gradient-to-r from-[#0071BC] to-[#B0E5F2] text-[#3E5C75]  h-32 md:h-48 w-full md:w-full mb-4 rounded-2xl">
       <div> <div className="relative">
        ...
        <h1 className="md:text-4xl  text-[#ffffff] font-extrabold absolute top-11 md:top-auto text-md flex text-centre items-baseline pt-32 md:pl-10  pl-6 ">
  ...
  />
      ...
      ) :(<div className="  all-products grid grid-cols-2 gap-10 sm:gap-10 sm:grid-cols-2  lg:grid-cols-3 xl:grid-cols-5 2xl:grid-cols-5 md:gap-10 py-10 mb-5 mx-2 ">
