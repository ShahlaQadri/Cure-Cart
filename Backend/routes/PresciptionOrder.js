...
import { getAllPresciptionOrders, getMyPastPresciption, getMyPresciptionOrders, getPresciptionOrderDetails, orderViaPresciption, processStatus } from "../controllers/PresciptionOrder.js";
...
router.route("/:id").get(getPresciptionOrderDetails).put(processStatus);
